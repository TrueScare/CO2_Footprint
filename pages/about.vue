...
<template>
  ...
  <FillsSmartSection id="woher">
    ...
    <template v-slot:default>
      <p>Aus einer Idee der Transparenz!</p>
      <p>
  ...
  <FillsSmartSection id="zusamenarbeit">
    <template v-slot:title>Wir sind ein TEAM</template>
    <template v-slot:default>
      <p>Zusammenhalt und Zusammenarbeit sind bei uns im Vordergrund.</p>
      <p>
        Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et
        dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet
        clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.
      ...
      <!-- TODO: insert elements with faces of ppl -->
      <p>
        Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et
        dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet
        clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet,
