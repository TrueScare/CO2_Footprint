<template>
  <FillsSmartSection
      id="agb"
  >
    <template v-slot:title>AGB</template>
    <template v-slot:default>
      <p>Hier gehören rechtlich bindenden Texte hin, die auf die Nutzung deines Produkts Einfluss haben. Gibt es
        Gebühren oder anderweitige Kosten beim Rücksenden von z.B. Artikeln?
      </p>
      <p>
      ...
      <FillsSmartSection
          id="section-1"
      >
        <template v-slot:title>Sektion 1</template>
        <p>
          Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et
          dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet
          clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet,
